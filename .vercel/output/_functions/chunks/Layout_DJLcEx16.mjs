...
import { d as createRenderInstruction, m as maybeRenderHead, c as addAttribute, r as renderComponent, b as renderTemplate, e as renderSlot, f as renderHead } from './entrypoint_D0Sz372f.mjs';
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header id="site-header"${addAttribute(isHome, "data-is-home")}${addAttribute(`md:py-4 py-3 md:fixed ${isHome ? "fixed" : "sticky"} top-0 left-0 w-full z-50 bg-[#F0EBE5] transition-all duration-500 shadow-sm ${isHome ? "opacity-0 -translate-y-full" : "opacity-100 translate-y-0"}`, "class")}> <div class="container mx-auto px-6 md:px-12"> <div class="flex items-center justify-between"> <!-- Desktop Left Nav --> <nav class="hidden md:flex items-center gap-12 flex-1"> <a href="/about" class="text-xs uppercase tracking-[0.4em] font-medium text-[#3B2D20] hover:text-[#8A5633] transition-colors">About</a> <a href="/collection" class="text-xs uppercase tracking-[0.4em] font-medium text-[#3B2D20] hover:text-[#8A5633] transition-colors">Collection</a> </nav> <!-- Mobile Left: Menu Trigger --> <div class="md:hidden flex-1 flex items-center"> <button class="mobile-menu-open text-[#3B2D20]"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M4 8h16M4 16h16"></path> </svg> </button> </div> <!-- Center: Logo --> <div class="flex-shrink-0"> <a href="/" class="transition-transform duration-700 hover:scale-105 block"> ${renderComponent($$result, "Image", $$Image, { "src": Logo, "alt": "floravelle", "class": "w-10 md:w-14 h-auto object-contain" })} </a> </div> <!-- Desktop Right Nav --> <nav class="hidden md:flex items-center justify-end gap-12 flex-1"> <a href="/contact" class="text-xs uppercase tracking-[0.4em] font-medium text-[#3B2D20] hover:text-[#8A5633] transition-colors">Contact</a> <a href="/checkout" class="text-xs uppercase tracking-[0.4em] font-medium text-[#3B2D20] hover:text-[#8A5633] transition-colors">Checkout</a> <div class="flex items-center gap-6"> ${renderComponent($$result, "CartButton", CartButton, { "client:load": true, "dark": true, "className": "hidden md:flex", "client:component-hydration": "load", "client:component-path": "/home/aimal-shah/code/floravelle/src/components/CartButton", "client:component-export": "default" })} <a href="/collection" class="text-[0.6rem] border border-[#8A5633]/30 px-5 py-2 hover:bg-[#8A5633] hover:text-white transition-all uppercase tracking-[0.3em] font-semibold">Shop Now</a> </div> </nav> <!-- Mobile Right: Cart --> <div class="md:hidden flex-1 flex justify-end items-center gap-4"> ${renderComponent($$result, "CartButton", CartButton, { "client:load": true, "dark": true, "client:component-hydration": "load", "client:component-path": "/home/aimal-shah/code/floravelle/src/components/CartButton", "client:component-export": "default" })} </div> </div> </div> </header> ${renderScript($$result, "/home/aimal-shah/code/floravelle/src/components/header.astro?astro&type=script&index=0&lang.ts")}`;
