...
const heroMobileBg = new Proxy({"src":"/_astro/hero-4.BIK0dDtR.jpeg","width":4950,"height":2100,"format":"jpg","orientation":1}, {
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="hero" class="relative overflow-hidden bg-[#F0EBE5] md:h-[100dvh]"> ${renderComponent($$result, "Image", $$Image, { "src": heroMobileBg, "alt": "Floravelle Hero Desktop", "class": "absolute inset-0 w-full h-full object-cover md:object-[right_top] object-center z-0 hidden md:block", "loading": "eager", "fetchpriority": "high" })} <!-- Mobile Single Image (16:9) --> <div class="block md:hidden w-full aspect-video relative z-0"> ${renderComponent($$result, "Image", $$Image, { "src": heroMobileBg, "alt": "Floravelle Hero Mobile", "class": "w-full h-full object-cover object-center", "loading": "eager", "fetchpriority": "high" })} <div class="absolute inset-0 bg-black/10"></div> </div> <div class="absolute top-4 left-1/2 -translate-x-1/2 z-20 pointer-events-none"> <div class="text-center text-white/90 font-roboto"> <p class="text-[10px] md:text-xs tracking-[0.2em] uppercase">
Floravelle Signature Collection
</p> <p class="text-[9px] md:text-[11px] tracking-[0.14em] uppercase mt-1 text-white/80">
Crafted for everyday elegance
</p> </div> </div> <div class="container h-full md:px-0 px-10 mx-auto text-white hidden md:flex flex-col justify-center md:gap-12 font-heading pt-32 z-10 relative pointer-events-none"> <div class="flex flex-1 md:flex-row flex-col justify-between w-full pointer-events-auto"> <div class="h-fit overflow-hidden flex items-center"> <h1 class="md:text-[14rem] text-6xl translate-y-90 heading font-heading">Timeless</h1> </div> <div class="flex flex-col gap-2 justify-center text-xs md:text-lg font-roboto translate-y-60 opacity-0 paragraph"> <p class="text-right md:text-left">Elegance isn't occasional — it is woven into the quiet rhythm<br class="md:block hidden"> of everyday moments, shaping the way you move through the<br class="md:block hidden"> world and defining a presence that lingers long after you leave.</p> <a href="/collection" class="text-right underline cursor-pointer">EXPLORE THE COLLECTION</a> </div> </div> <div class="flex flex-1 justify-end items-center "> <div class="overflow-hidden h-fit"> <h1 class="md:text-[14rem] text-6xl text-right translate-y-96 heading leading-[0.8] py-4">Fragrance</h1> </div> </div> </div> </section> ${renderScript($$result, "/home/aimal-shah/code/floravelle/src/components/hero.astro?astro&type=script&index=0&lang.ts")}`;
